...
export const metadata: Metadata = {
  title: "Nawio — Nawigator dokumentów korporacyjnych dla sp. z o.o.",
  description:
  ...
  openGraph: {
    title: "Nawio — Nawigator korporacyjny dla sp. z o.o.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Nawio — Nawigator dokumentów korporacyjnych",
      },
    ],
    locale: "pl_PL",
    type: "website",
